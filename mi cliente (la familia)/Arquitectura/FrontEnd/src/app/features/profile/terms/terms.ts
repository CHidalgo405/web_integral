      ...
      <div class="terms-container">
        ...
        <section id="section-3">
          ...
          <ul>
            ...
            <li><strong>Comunicaciones de Marketing (Sujeto a Consentimiento):</strong> Para enviararle alertas push o correos electrónicos con promociones exclusivas, ventas relámpago, códigos de descuento y boletines informativos. El Usuario conserva siempre el derecho a cancelar su suscripción a estas comunicaciones en la configuración de su perfil ("Opt-out").</li>
          </ul>
